...
export default function ResumeSelector({
  ...
  const totalPages = resumes ? Math.ceil(resumes.length / itemsPerPage) : 0;
    ...
    <div className="space-y-4">
      ...
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg">
        ...
        >
          ...
          <ChevronDown
            className={`h-4 w-4 transition-transform ${resumesOpen ? "rotate-180" : ""}`}
          />
        </button>
        ...
        {resumesOpen && (
          <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-3 overflow-hidden">
              ...
              {resumes?.map((resume: any) => (
                ...
                >
                          ...
                          <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                            ...
                            {resume.lastExported && (
                              <div className="flex items-center gap-1">
                                ...
                                <span>Template: {resume.theme}</span>
                              </div>
                            )}
                          </div>
                        </div>
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    >
                      <Star
                        className={`h-3 w-3 ${resume.isDefault ? "fill-yellow-400 text-yellow-400" : "text-gray-400"}`}
                      />
                    </Button>
            ...
            <div className="hidden lg:block space-y-2">
              ...
              {resumes && resumes.length > itemsPerPage && (
